...
import { FaChalkboardTeacher, FaBookOpen, FaUserGraduate, FaClipboardList, FaFileAlt, FaBuilding } from "react-icons/fa";

export default function NeetProgramsSection() {
   const features = [
    {
        ...
        <div className="w-full lg:w-[70%] flex flex-col justify-between gap-6">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm md:text-base mb-4">
              WavePlus Academy’s Class XI NEET program is tailored for students aiming to crack the NEET UG exam.
              Our expert faculty covers the entire Class XI syllabus of Physics, Chemistry, and Biology in-depth,
              following both board and NEET perspectives. The course includes daily lectures, NCERT-based problem-solving,
              doubt-clearing sessions, and regular NEET-style tests. We emphasize concept building and application with
              practice sheets, assignments, and test analysis. Early NEET preparation in Class XI builds the foundation
              students need to confidently handle Class XII and the final NEET exam.
            </p>
            <p className="text-gray-700 text-sm md:text-base mb-4">
              Our Class XII NEET program is an advanced, result-driven course that combines board exam preparation
              with full-scale NEET coaching. We complete the syllabus with timely revisions, focus on high-yield NEET topics,
              and conduct frequent mock tests based on NTA patterns. The program includes concept reinforcement, one-on-one
              doubt-solving, and time-management training. Special crash courses and full-length test series simulate the
              real NEET exam environment. Students are guided every step—from strategy planning to stress handling—ensuring
              they’re confident and exam-ready.
            </p>
            <p className="text-gray-700 text-sm md:text-base font-medium">
              <strong>Eligibility:</strong> Minimum age of 17 years as of December 31 of the year of admission is mandatory
              for NEET aspirants. Candidates must have passed 10+2 with Physics, Chemistry, Biology/Biotechnology,
