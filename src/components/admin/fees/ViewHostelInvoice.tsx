        ...
        <div className="  border-2 border-site-darkgreen rounded-md flex flex-col h-full  ">
          ...
          <div className="text-sm text-site-gray grid grid-cols-2 gap-4 p-4">
            ...
            <div>
              ...
              {studentData.currentCourse?.course_name || "-"}{" "}
            </div>
            <div>
              {" "}
              <strong>Class:</strong> {studentData.currentClass}
            </div>
            <div>
              {" "}
          ...
          <div className="flex flex-col border-t-3 border-site-darkgreen ">
            ...
            <div className="w-full flex flex-col  ">
              <div className="w-full flex flex-col text-site-gray">
                <div className="flex flex-row items-center w-full">
                  <div className="w-[15%] p-4 border-r border-site-darkgreen">
                    1
                  </div>
                  <div className="w-[65%] p-4 border-r border-site-darkgreen">
                    Hostel Fees for {hostelFeeMonth.month} {hostelFeeMonth.year}{" "}
                    ({hostelFeeMonth.scholarship}%)
                  </div>
                  <div className="w-[20%] p-4">{hostelFeeMonth.amount}</div>
                </div>

                {hostelFeeMonth.due && Number(hostelFeeMonth.due) > 0 && (
                  <div className="flex flex-row items-center w-full">
                    <div className="w-[15%] p-4 border-r border-site-darkgreen">
                      2
                    </div>
                    ...
                    <div className="w-[20%] p-4">{hostelFeeMonth.due}</div>
                  </div>
                )}
              </div>

              <div className="flex justify-end p-4 font-semibold text-lg w-full bg-site-darkgreen/10 border-t-3 border-site-darkgreen text-site-darkgreen">
                Total: &#8377; {hostelFeeMonth.amount}
              </div>
            </div>
          </div>
        </div>
...
export default ViewHostelInvoice;
