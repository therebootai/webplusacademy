    ...
    <div className="relative bg-white rounded-2xl px-3 py-5 border border-[#eeeeee] z-[100] w-64">
      ...
      <div className="flex flex-col gap-2 text-site-gray">
        <div className="px-3 py-2 border border-[#eeeeee]  rounded">
          <strong>Amount Paid: </strong> ₹{emiData.paid || "0"}
        </div>
        <div className="px-3 py-2 border border-[#eeeeee]  rounded">
          <strong>Scholarship: </strong> {emiData.scholarship || "-"}
        </div>
        <div className="px-3 py-2 border border-[#eeeeee]  rounded">
          {emiData.uploadReceipt?.secure_url ? (
            <Link
              href={emiData.uploadReceipt.secure_url}
              target="_blank"
        ...
        <div className="px-3 py-2 border border-[#eeeeee]  rounded">
          <strong>Due: </strong> ₹{emiData.due || "0"}
        </div>
        <div className="px-3 py-2 border border-[#eeeeee]  rounded">
          <strong>Remarks: </strong> {emiData.remarks || "-"}
        </div>
      </div>
    </div>
  );
